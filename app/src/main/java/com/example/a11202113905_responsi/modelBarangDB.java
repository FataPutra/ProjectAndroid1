...
public class modelBarangDB {
    ...
    public modelBarangDB(String kode_barang, String nama_barang, String harga_barang, String satuan_barang,String stok_barang, Bitmap gambar_barang) {
